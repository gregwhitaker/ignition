...
class UserGroup:
    ...
    __group_name = 'User'
    __policy_name = 'User'
    __policy_file_name = 'iam-user-group.json'
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Adds or removes the user group from the account.")

    command_group = parser.add_mutually_exclusive_group()
    command_group.add_argument("-s", "--setup", help="Adds the user group to the account.", action="store_true")
    command_group.add_argument("-t", "--teardown", help="Removes the user group from the account.", action="store_true")
